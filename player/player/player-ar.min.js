var Main = {
        ...
        showNextButton: function (t) {
            t.customID ? (Main.$customNextButton = $("#" + t.customID), Main.$customNextButton.one("click", Main.onNextButtonPressed), Main.$customNextButton.show()) : (Main.$nextButton.one("click", Main.onNextButtonPressed), Main.rotateNavigationButton(Main.$nextButton)), t.disableReplay || Main.soundManager.showReplayButton(t.customReplayID)
        },
